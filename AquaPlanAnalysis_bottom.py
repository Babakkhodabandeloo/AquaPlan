...
# Time selection
start_time = "2024-11-03 15:44:00" # Select subset of data
...
hv.save(bottom_plot, 'bottom_depth.png')   # PNG
#================================================
...
# Save
hv.save(final_plot, 'sv_38kHz_with_bottom.png')
...
hv.save(OnePing , 'single_ping.png')
